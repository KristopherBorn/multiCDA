...
public class CriticalPairNode {
	...
	/**
	 * The <code>URI</code>s of the two involved diagram files.
	 */
	URI firstRuleDiagramURI, secondRuleDiagramURI;
	...
	/**
	 * @return the firstRuleDiagramURI
	 */
	public URI getFirstRuleDiagramURI() {
		return firstRuleDiagramURI;
	}

	/**
	 * @param firstRuleDiagramURI the firstRuleDiagramURI to set
	 */
	public void setFirstRuleDiagramURI(URI firstRuleDiagramURI) {
		this.firstRuleDiagramURI = firstRuleDiagramURI;
	}

	/**
	 * @return the secondRuleDiagramURI
	 */
	public URI getSecondRuleDiagramURI() {
		return secondRuleDiagramURI;
	}

	/**
	 * @param secondRuleDiagramURI the secondRuleDiagramURI to set
	 */
	public void setSecondRuleDiagramURI(URI secondRuleDiagramURI) {
		this.secondRuleDiagramURI = secondRuleDiagramURI;
	}
}
