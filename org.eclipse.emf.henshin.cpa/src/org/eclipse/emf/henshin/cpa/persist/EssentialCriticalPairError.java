 ...
 *
 */
public class EssentialCriticalPairError extends CriticalPairNode{
...
//	private URI criticalPairDummyURI;
	 ...
	 */
	public EssentialCriticalPairError(String numberedNameOfCPKind, URI firstRuleURI, URI secondRuleURI, URI minimalModelURI,
			URI criticalPairURI) {
		super(numberedNameOfCPKind, firstRuleURI, secondRuleURI, minimalModelURI, criticalPairURI);
