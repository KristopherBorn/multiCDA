 ...
 * <li>{@link org.eclipse.emf.henshin.model.Node#getAttributes
 * <em>Attributes</em>}</li>
 * <li>{@link org.eclipse.emf.henshin.model.Node#getGraph <em>Graph</em>}</li>
 * <li>{@link org.eclipse.emf.henshin.model.Node#getIncoming
 * <em>Incoming</em>}</li>
 * <li>{@link org.eclipse.emf.henshin.model.Node#getOutgoing
 * <em>Outgoing</em>}</li>
 * </ul>
 * </p>
 *
 ...
 *        NodeDeletionDanglingEdge NodeCreationWithoutContainment'"
 * @generated
 */
public interface Node extends NamedElement, GraphElement {
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.henshin.model.Node#getType
	 ...
	 * {@link org.eclipse.emf.henshin.model.Attribute}. It is bidirectional and
	 * its opposite is '{@link org.eclipse.emf.henshin.model.Attribute#getNode
	 ...
	 * '{@link org.eclipse.emf.henshin.model.Graph#getNodes <em>Nodes</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.henshin.model.Node#getGraph
	 ...
	 * list contents are of type {@link org.eclipse.emf.henshin.model.Edge}. It
	 * is bidirectional and its opposite is
	 * '{@link org.eclipse.emf.henshin.model.Edge#getTarget <em>Target</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * list contents are of type {@link org.eclipse.emf.henshin.model.Edge}. It
	 * is bidirectional and its opposite is
	 * '{@link org.eclipse.emf.henshin.model.Edge#getSource <em>Source</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * <!-- begin-user-doc --> Returns an <b>unmodifiable</b> list of all
	 * coinciding edges of a node.<br>
	 * Remark: This list is a snapshot of the current set of incoming and
	 * outgoing edges i.e. it is not synchronized with subsequent changes of the
	 * sets of incoming and outgoing edges. After such changes this method has
	 * to be called again to retrieve an updated list of edges. <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * <!-- begin-user-doc --> Returns an <b>unmodifiable</b> list which
	 * contains all outgoing edges this node contains, which are of the given
	 * type.<br>
	 ...
	 * updated list of edges. <!-- end-user-doc -->
	 * 
	...
	/**
	 * <!-- begin-user-doc --> Returns an <b>unmodifiable</b> list which
	 * contains all incoming edges this node contains, which are of the given
	 * type.<br>
	...
	/**
	 * <!-- begin-user-doc --> Returns an {@link Edge} with this node as source,
	 * the given node as target and the given type as edge type. If no such
	 * instance can be found, <code>null</code> is returned <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * <!-- begin-user-doc --> Returns an {@link Edge} with this node as target,
	 * the given node as source and the given type as edge type. If no such
	 * instance can be found, <code>null</code> is returned <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * <!-- begin-user-doc --> Returns an {@link Attribute} instance according
	 * to the give attribute type. If no such instance can be found,
	 * <code>null</code> is returned <!-- end-user-doc -->
	 * 
	 * @model
	 * @generated
	 */
