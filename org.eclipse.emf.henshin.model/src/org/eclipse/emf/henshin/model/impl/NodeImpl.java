 ...
 * <ul>
 * <li>{@link org.eclipse.emf.henshin.model.impl.NodeImpl#getAction
 * <em>Action</em>}</li>
 * <li>{@link org.eclipse.emf.henshin.model.impl.NodeImpl#getType
 * <em>Type</em>}</li>
 * <li>{@link org.eclipse.emf.henshin.model.impl.NodeImpl#getAttributes
 * <em>Attributes</em>}</li>
 * <li>{@link org.eclipse.emf.henshin.model.impl.NodeImpl#getGraph
 * <em>Graph</em>}</li>
 * <li>{@link org.eclipse.emf.henshin.model.impl.NodeImpl#getIncoming
 * <em>Incoming</em>}</li>
 * <li>{@link org.eclipse.emf.henshin.model.impl.NodeImpl#getOutgoing
 * <em>Outgoing</em>}</li>
 * </ul>
 * </p>
 *
...
public class NodeImpl extends NamedElementImpl implements Node {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HenshinPackage.NODE__TYPE, oldType,
							type));
			}
		}
		return type;
	...
	public EList<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentWithInverseEList.Resolving<Attribute>(Attribute.class, this,
					HenshinPackage.NODE__ATTRIBUTES, HenshinPackage.ATTRIBUTE__NODE);
		}
		return attributes;
	}
	...
	public Graph getGraph() {
		if (eContainerFeatureID() != HenshinPackage.NODE__GRAPH)
			return null;
	...
	public void setGraph(Graph newGraph) {
		if (newGraph != eInternalContainer()
				|| (eContainerFeatureID() != HenshinPackage.NODE__GRAPH && newGraph != null)) {
	...
	public EList<Edge> getIncoming() {
		if (incoming == null) {
			incoming = new EObjectWithInverseResolvingEList<Edge>(Edge.class, this, HenshinPackage.NODE__INCOMING,
	...
	public EList<Edge> getOutgoing() {
		if (outgoing == null) {
			outgoing = new EObjectWithInverseResolvingEList<Edge>(Edge.class, this, HenshinPackage.NODE__OUTGOING,
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == GraphElement.class) {
			...
			case HenshinPackage.GRAPH_ELEMENT__ACTION:
				return HenshinPackage.NODE__ACTION;
			default:
				return -1;
			}
		}
