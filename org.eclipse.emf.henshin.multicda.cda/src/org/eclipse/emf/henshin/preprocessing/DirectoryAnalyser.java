...
public class DirectoryAnalyser {
	...
	public class AnalysisResult{
		...
		public AnalysisResult(int numberOfFiles, int numberOfFilesWithUnits, int numberOfRules, int numberOfUnits, int numberOfRulesContainingAC, int numberOfRulesContainingMultirules, int numberOfMultiRules, int numberOfCreatingRules, int numberOfDeletingRules){
	...
	public static AnalysisResult analyseDirectory(String fullSubDirectoryPath){
		...
		AnalysisResult analysisResult = new DirectoryAnalyser().new AnalysisResult(numberOfFiles, numberOfFilesWithUnits, numberOfRules, numberOfUnits, numberOfRulesContainingAC, numberOfRulesContainingMultirules, numberOfMultiRules, numberOfCreatingRules, numberOfDeletingRules);
