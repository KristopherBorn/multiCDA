...
public class IntegrationTest {
	...
	public void conflictAtoms_decapsulateAttr_decapsulateAttr() {
		ConflictAnalysis atomicCoreCPA = new ConflictAnalysis(decapsulateAttributeRule, decapsulateAttributeRule);
		List<ConflictAtom> computedConflictAtoms = atomicCoreCPA.computeConflictAtoms();
		assertEquals(3, computedConflictAtoms.size());
	}

	// erwartet: 1,11->4,12:variables , 1,11->2,13:methods , 1,11->3,13:methods
	// , 1,11->2,14:methods , 1,11->3,14:methods
	@Test
	...
	// erwartet: 11,11->12,12:variables , 11,11->13,13:methods ,
	// 11,11->13,14:methods , 11,11->14,14:methods , 11,11->14,13:methods
	@Test
	...
	// erwartet: 2,13:Method , 2,14:Method , 3,13:Method, 3,14:Method und
	// 5,15:Parameter - 5 Stück
	@Test
	public void conflictPartCandidates_decapsulateAttr_pullUpEncAttr_Test() {
		AtomCandidateComputation candComp = new AtomCandidateComputation(decapsulateAttributeRule,
				pullUpEncapsulatedAttributeRule);
		List<Span> computedConflictPartCandidates = candComp.computeAtomCandidates();
		assertEquals(5, computedConflictPartCandidates.size());
	}

	// erwartet: 2,2:Method , 2,3:Method , 3,2:Method , 3,3:Method und
	// 5,5:Parameter - 5 Stück
	@Test
	...
	// erwartet: 1,11->4,12:variables , 1,11->2,13:methods , 1,11->3,13:methods
	// , 1,11->2,14:methods , 1,11->3,14:methods - 5 Stück
	@Test
	...
	// erwartet: 11,11->12,12:variables , 11,11->13,13:methods ,
	// 11,11->13,14:methods , 11,11->14,14:methods , 11,11->14,13:methods - 5
	// Stück
	@Test
	...
	public void conflictMinReason_pullUpEncAttr_pullUpEncAttr() {
		...
		Set<MinimalConflictReason> reasons = new HashSet<>();//
		for (Span candidate : conflictAtomCandidates) {
			atomicCoreCPA.computeMinimalConflictReasons( candidate, reasons);
		}
		assertEquals(5, reasons.size());
	}
	 ...
	 * conflict reason? [!] DONE! 2 für "decapsulate"->"pullUp" getestet in
	 * ComputeMinReasonTest
	 */
