...
public class DeleteDeleteConflictReasonComputation {
	...
	private Object nonDelConflictReasons;
	 ...
	 * @param result
	 */
	private void computeDeleteDeleteConflictReason(ConflictReason initialReason, Set<DDSpan> result) {
	 ...
	 * @return
	 */
	private DeleteUseConflictReason ConstructDeleteDeleteSet(ConflictReason initialReason) {
