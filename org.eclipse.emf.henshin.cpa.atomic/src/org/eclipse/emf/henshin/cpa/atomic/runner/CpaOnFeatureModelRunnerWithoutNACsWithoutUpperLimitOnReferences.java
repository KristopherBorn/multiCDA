...
public class CpaOnFeatureModelRunnerWithoutNACsWithoutUpperLimitOnReferences extends Runner{
...
//		deactivatedRules.add("Refactoring_1-4"); // bringt ähnlich gute ERgebnisse wie die anderen Refactorings, ist daher also bei Bedarf verzichtbar
		...
		deactivatedRules.add("removeFromGroup_features_Feature"); // [exhausting in normalCPA] bringt auf für essential und atomic halbwegs interessante Ergebnisse
		...
		String subDirectoryPath = "testData\\featureModelingWithoutUpperLimitsOnReferences\\fmedit_noAmalgamation_noNACs\\rules\\";
