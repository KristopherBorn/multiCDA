...
public class NanoXMLTest {
	...
	final String PATH = "visualContracts-nanoXML/";
	final String henshinFileName = "nanoXML.henshin";

	
	// unimplemented (not finished to adapt) jet!
...
//
//	@Test
//	public void testEssConflictsWithInvertedRules_shouldBeDependencies() {
