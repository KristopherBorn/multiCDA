...
public class CospanMappingToMaps {
	...
	Map<Node, Node> rule1ToG = new HashMap<Node, Node>();
	Map<Node, Node> gToRule1 = new HashMap<Node, Node>();
	Map<Node, Node> rule2ToG = new HashMap<Node, Node>();
	Map<Node, Node> gToRule2 = new HashMap<Node, Node>();
