...
public class InitialReasonComputation {
	...
	public Set<InitialReason> computeInitialReasons() {
		Set<MinimalConflictReason> minimalReasons = new HashSet<MinimalConflictReason>();
		MinimalReasonComputation minimalReasonComputation = new MinimalReasonComputation(rule1,rule2);
		minimalReasonComputation.computeMinimalConflictReasons().forEach(r -> minimalReasons.add(r));
		return computeInitialReasons(minimalReasons);
	}
