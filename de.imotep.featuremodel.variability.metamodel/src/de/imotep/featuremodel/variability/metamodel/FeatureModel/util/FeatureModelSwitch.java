	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FeatureModelPackage.REQUIRE_CONSTRAINT: {
				...
				if (result == null) result = caseConstraint(requireConstraint);
				if (result == null) result = caseNamedElement(requireConstraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeatureModelPackage.EXCLUDE_CONSTRAINT: {
				...
				if (result == null) result = caseConstraint(excludeConstraint);
				if (result == null) result = caseNamedElement(excludeConstraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
