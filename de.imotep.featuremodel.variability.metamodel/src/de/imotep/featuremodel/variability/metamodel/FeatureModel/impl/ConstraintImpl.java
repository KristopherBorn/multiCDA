 ...
 * <ul>
 *   <li>{@link de.imotep.featuremodel.variability.metamodel.FeatureModel.impl.ConstraintImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link de.imotep.featuremodel.variability.metamodel.FeatureModel.impl.ConstraintImpl#getCode <em>Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ConstraintImpl extends NamedElementImpl implements Constraint {
	...
	public void setCode(String newCode) {
		...
		code = newCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.CONSTRAINT__CODE, oldCode, code));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FeatureModelPackage.CONSTRAINT__LANGUAGE:
				return getLanguage();
			case FeatureModelPackage.CONSTRAINT__CODE:
				return getCode();
		}
