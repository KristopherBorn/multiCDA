...
public class FeatureModelFactoryImpl extends EFactoryImpl implements FeatureModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case FeatureModelPackage.COMMENT: return createComment();
			case FeatureModelPackage.FEATURE: return createFeature();
			case FeatureModelPackage.REQUIRE_CONSTRAINT: return createRequireConstraint();
			case FeatureModelPackage.EXCLUDE_CONSTRAINT: return createExcludeConstraint();
